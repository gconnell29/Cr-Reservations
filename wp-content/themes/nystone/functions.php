...
function wpbsearchform( $form ) {
    ...
    <input class="searchform_input" type="text" value="' . get_search_query() . '" name="s" id="s" placeholder="Search New York Stone" autocorrect="off" autocapitalize="off" autocomplete="off" spellcheck="off"/>

    <input class="searchform_button" type="submit" id="searchsubmit" value="'. esc_attr__('') .'" />
...
function wpbsearchform1( $form ) {
    ...
    <input class="searchadv_input" type="search" value="' . get_search_query() . '" name="s" id="s" placeholder="" autocorrect="off" autocapitalize="off" autocomplete="off" spellcheck="off"/>

    <input class="primary_btn" type="submit" id="searchsubmit" value="'. esc_attr__('Search') .'" />
...
add_shortcode('wpbsearch1', 'wpbsearchform1');

// Change the add to cart text on shop page
...
echo do_shortcode('<a href="'.$link.'" class="button addtocartbutton">Take A Look</a>');
}
